...
## Exercise
  * Install git on your system. 
    ...
    On MS Windows, install "git for windows". Here is a [guideline](https://github.com/shub6059/PiTutorial/blob/master/git%20for%20windows.md). 
...
A list of key concepts about Python 3 is here: https://github.com/shub6059/PyBasic#2-python-3-programming.
...
5. Run the following Python Code.
   ...
   The code is in https://raw.github.com/shub6059/PiTutorial/master/src/led.py.
   You can download and run it as follows.

   ```bash
   wget https://raw.github.com/shub6059/PiTutorial/master/src/led.py
   python3 led.py
   ```
...
2. Run the following Python code and check the output changes from 0 to 1 as you push the pushbutton.
   ...
   The code is in https://raw.github.com/shub6059/PiTutorial/master/src/push.py.
   You can download and run it as follows.
   ```bash
   wget https://raw.github.com/shub6059/PiTutorial/master/src/push.py
   python3 push.py
   ```
